    ...
    <div v-else class="card-bg p-4 md:p-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <li>
          ...
          <span
            v-else-if="leaveApplication?.user?.leave_approval?.in_charge_user_id === authStore.user.id"
          >
            <button
              class="btn-link"
        ...
        <li>
          ...
          <span
            v-else-if="leaveApplication?.user?.leave_approval?.coordinator_user_id === authStore.user.id"
          >
            <button
              class="btn-link"
        ...
        <li>
          ...
          <span
            v-else-if="leaveApplication?.user?.leave_approval?.operational_admin_user_id === authStore.user.id"
          >
            <button
              class="btn-link"
        ...
        <li>
          ...
          <span
            v-else-if="leaveApplication?.user?.leave_approval?.recommend_by_user_id === authStore.user.id"
          >
            <button
              class="btn-link"
        ...
        <li>
          ...
          <span
            v-else-if="leaveApplication?.user?.leave_approval?.approved_by_user_id === authStore.user.id"
          >
            <button
              class="btn-link"
