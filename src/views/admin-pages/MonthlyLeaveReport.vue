...
<template>
  <div class="w-full min-w-0 space-y-3 px-3 md:px-4">
    ...
    <div class="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
      ...
      <div class="border-t border-slate-100 bg-slate-50 px-3 py-2">
        ...
        <div class="mt-2 flex flex-wrap items-center justify-between gap-2">
          <div class="flex items-center gap-2">
            <label
              class="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 py-2 text-[11px] font-semibold text-slate-700"
            >
    ...
    <div v-else class="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
      <div class="flex flex-wrap items-center justify-between gap-2 border-b border-slate-100 bg-white px-4 py-3">
        <div class="min-w-0">
          ...
          <thead class="text-[10px] uppercase tracking-wide text-slate-500">
            <tr class="bg-slate-100">
              ...
              <th
                v-for="d in days"
                :key="d.date"
                class="px-2 py-2 text-center border-l border-slate-200 whitespace-nowrap"
                :title="d.date"
              >
