...
const saveUser = async () => {
  try {
    const weekendPayload =
      selectedWeekend.value?.weekends?.length > 0 ? { ...selectedWeekend.value } : null
        ...
        <div class="grid gap-4">
          <div class="border p-4 rounded-md bg-gray-100">
            ...
            <div class="grid md:grid-cols-2 gap-4">
              ...
              <div class="space-y-1">
                <label class="block text-sm font-semibold text-gray-700">Bangla Name</label>
                <input
          ...
          <div class="border p-4 rounded-md bg-gray-100">
            ...
            <div class="grid md:grid-cols-2 gap-4">
              <div class="space-y-1">
                ...
                <select id="company_id" v-model="form.company_id" class="input-light" required>
              ...
              <div class="space-y-1">
                ...
                <select v-model="form.department_id" class="input-light">
              ...
              <div class="space-y-1">
                ...
                <select v-model="form.designation_id" class="input-light">
              ...
              <div class="space-y-1">
                ...
                <select v-model="form.employment_type" class="input-light">
              ...
              <div class="space-y-1">
                <label class="block text-sm font-semibold text-gray-700">
                  Line Type <span class="text-red-600">*</span>
                </label>
                <select v-model="form.type" class="input-light" required>
          ...
          <div class="border p-4 rounded-md bg-gray-100">
            ...
            <div class="grid md:grid-cols-4 gap-4">
              ...
              <div class="space-y-1">
                <label class="block text-sm font-semibold text-gray-700">Device User ID</label>
                <input
