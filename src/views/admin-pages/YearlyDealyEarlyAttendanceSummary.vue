  ...
  <section class="space-y-4 px-4">
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
      <div class="grid gap-3 items-end lg:grid-cols-[120px_1.2fr_1.2fr_1fr_1.2fr_140px_160px]">
        ...
        <div class="min-w-0">
          <label class="text-xs font-semibold uppercase tracking-wide text-slate-500">Line Type</label>
          <SelectDropdown
    ...
    <div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
      ...
      <div v-else-if="rows.length === 0" class="empty-state">
        ...
        <p class="text-sm text-slate-500">Try changing filters or year.</p>
      </div>

      <div v-else class="overflow-x-auto table-scroll">
        <table class="min-w-full table-auto border-collapse">
          <thead class="sticky top-0 bg-white shadow-sm">
            <tr class="bg-gray-50 text-xs text-left">
