...
const props = defineProps({
  ...
  id: { type: [String, Number], required: true }, // exchange id
})
      ...
      <div class="fixed inset-0 flex items-center justify-center p-4" @keydown.esc="close">
        ...
        >
          ...
          <div class="sticky top-0 z-10 flex items-center justify-between gap-2 border-b bg-white px-4 py-3 print:hidden">
            ...
            <h1 id="exchange-title" class="title-lg text-center">Shift Exchange Application</h1>
            <div>
              <button class="btn-3" @click="close">
          ...
          <div class="p-4">
            ...
            <div
              v-else
              class="bg-white rounded text-sm md:text-base"
            ...
            >
              ...
              <div class="grid grid-cols-2 text-sm md:text-base md:grid-cols-3 md:gap-x-4 items-end">
                <ApprovalItem
                  :application="exchange"
                  type="shift_exchange_applications"
                  item="handover"
